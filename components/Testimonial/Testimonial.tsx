...
const testimonial: TestimonialItem[] = [
  {
    ...
    tImg: tImg1,
    logo: icon1,
    Des: "Working with getsyncpeak was fantastic! Their Bulk SMS and DLT support improved our delivery rates and cut campaign setup time.",
    Name: 'Christopher Smith',
    sub: 'Growth Lead at Near',
  ...
  },
  {
    ...
    tImg: tImg2,
    logo: icon2,
    Des: "getsyncpeak exceeded all our expectations! Their WhatsApp Business API helped us lift customer response rates by 150%.",
    Name: 'Sarah Davis',
    sub: 'Marketing Lead at Spinlet',
  },
  {
    id: '03',
    tImg: tImg3,
    logo: icon3,
    Des: "Choosing getsyncpeak was a great decision. Their RCS and voice APIs helped us reach customers on every channel, real success!",
    Name: 'Robert Miller',
  ...
  },
  {
    ...
    tImg: tImg4,
    logo: icon4,
    Des: "Since partnering with getsyncpeak, our message delivery has improved remarkably. Their platform and support are top-notch!",
  ...
  },
  {
    ...
    tImg: tImg3,
    logo: icon5,
    Des: "Since partnering with getsyncpeak, our OTP and voice verification success rate has improved remarkably. Reliable and fast!",
    Name: 'Amit Rao',
    sub: 'CTO at Kuda',
  },
  {
    ...
    tImg: tImg2,
    logo: icon2,
    Des: "getsyncpeak exceeded all our expectations! Their RCS rollout helped us achieve a remarkable 150% lift in engagement.",
    Name: 'Sarah Davis',
    sub: 'Marketing Lead at Spinlet',
  },
];
