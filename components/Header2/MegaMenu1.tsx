...
const MegaMenu1: React.FC = () => {
  const items = [
    { href: '/about', icon: '/images/icon/m_01.svg', title: 'About Us', desc: 'Learn more about getsyncpeak' },
                    ...
                    <div className="site_author">
                      <div className="author_box">
                        ...
                        <div className="author_box_content">
                          ...
                          <span className="author_designation text-white">CEO at getsyncpeak</span>
                        </div>
                      </div>
                      <p className="mb-0 text-white">
                        “As CEO at getsyncpeak, I’ve worked hard to clarify client requirements and deliver results
