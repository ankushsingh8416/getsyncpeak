...
const FunFact: FunFactItem[] = [
  {
    number: '500',
    title: 'Sending over',
    subTitle: "We're already helping 500M+ messages reach customers every month.",
    text: 'Messages delivered monthly',
    symbol: 'M+',
    icon: sIcon1,
    funImg1: fImg1,
    funImg2: fImg2,
  ...
  },
  {
    ...
    subTitle: "Businesses across India and beyond run their SMS, RCS and WhatsApp on getsyncpeak.",
    text: 'Businesses onboarded',
    symbol: '+',
    icon: sIcon2,
  ...
  },
  {
    number: '99',
    title: 'Delivering',
    subTitle: "Carrier-grade routing keeps your SMS, voice and WhatsApp traffic reliable, always.",
    text: 'Average delivery rate',
    symbol: '.9%',
    icon: sIcon3,
