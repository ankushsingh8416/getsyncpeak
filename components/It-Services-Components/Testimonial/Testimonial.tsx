...
const testimonial: TestimonialItem[] = [
  {
    ...
    Des: "getsyncpeak's Bulk SMS and DLT registration support helped us launch compliant campaigns in days instead of weeks. Delivery rates and reporting have been consistently strong across every carrier we use.",
    Name: "Rohan Mehta",
    sub: "Head of Marketing, UrbanCart",
  ...
  },
  {
    ...
    tImg: tImg2,
    tIcon: icon2,
    Title: "WhatsApp support that scales",
    Des: "Moving customer support to the WhatsApp Business API on getsyncpeak cut our response times in half. The onboarding team made template approval and go-live painless.",
    Name: "Ananya Sharma",
    sub: "Customer Success Lead, Finlyte",
  ...
  },
  {
    ...
    tImg: tImg3,
    tIcon: icon3,
    Title: "Voice OTP we can trust",
    Des: "We needed a dependable voice OTP fallback for logins. getsyncpeak's Voice API integrated quickly and has run without a single outage since we went live.",
    Name: "Vikram Nair",
    sub: "CTO, PayNova",
    country: "Pune, India",
  },
  {
    ...
    Des: "Having SMS, RCS, WhatsApp and voice under one API and one dashboard removed a lot of complexity from our stack. getsyncpeak's support team is quick and genuinely helpful.",
    Name: "Priya Desai",
    sub: "Product Manager, ShipEasy",
    country: "Delhi, India",
  },
];
